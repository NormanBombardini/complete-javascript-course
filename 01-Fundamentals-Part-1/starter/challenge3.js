...
console.log(`1. The bill was $${bill}, the tip was $${tip}, and the total value $${bill+tip}.`)

// 2.
bill = 40;
tip = bill>=50 && bill <= 300 ? bill * 0.15 : bill * 0.2;
console.log(`2. The bill was $${bill}, the tip was $${tip}, and the total value $${bill+tip}.`)

// 3.
bill = 430;
tip = bill >= 50 && bill <= 300 ? bill * 0.15 : bill * 0.2;
console.log(`3. The bill was $${bill}, the tip was $${tip}, and the total value $${bill+tip}.`)